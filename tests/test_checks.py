...
class CheckTests(unittest.TestCase):
    def test_pawn_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/4P3/4K3 w - -')
    ...
    def test_pawn_move_uncovered_bishop_check(self):
        board = pychess.board.SetupBoard('8/8/8/8/2k5/8/4P3/4KB2 w - -')
    ...
    def test_knight_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/4N3/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Nc3')
    ...
    def test_knight_move_uncovered_rook_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/3N4/3RK3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Nf3')
    ...
    def test_bishop_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/4B3/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Bf3')
    ...
    def test_bishop_move_uncovered_queen_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/3B4/3QK3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Be3')
    ...
    def test_rook_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/8/4KR2 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Rf5')
    ...
    def test_rook_move_uncovered_bishop_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/6R1/4K2B w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Rg8')
    ...
    def test_queen_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/8/4KQ2 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Qf3')
    ...
    def test_king_move_uncovered_rook_check(self):
        board = pychess.board.SetupBoard('8/8/8/3k4/8/8/3K4/3R4 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'Ke2')
    ...
    def test_knight_promotion_check(self):
        board = pychess.board.SetupBoard('8/5k1P/8/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'h8=N')

        king = board.get_king(pychess.PieceColor.BLACK)

        self.assertTrue(king.in_check() and board.algebraic_history()[-1] == 'h8=N+'
                        and len(board.get_knights(pychess.PieceColor.WHITE)) > 0)

    def test_knight_promotion_capture_check(self):
        board = pychess.board.SetupBoard('6r1/4k2P/8/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'hxg8=N')
    ...
    def test_bishop_promotion_check(self):
        board = pychess.board.SetupBoard('8/7P/5k2/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'h8=B')

        king = board.get_king(pychess.PieceColor.BLACK)

        self.assertTrue(king.in_check() and board.algebraic_history()[-1] == 'h8=B+'
                        and len(board.get_bishops(pychess.PieceColor.WHITE)) > 0)

    def test_bishop_promotion_capture_check(self):
        board = pychess.board.SetupBoard('6q1/7P/4k3/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'hxg8=B')
    ...
    def test_rook_promotion_check(self):
        board = pychess.board.SetupBoard('4k3/7P/8/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'h8=R')

        king = board.get_king(pychess.PieceColor.BLACK)

        self.assertTrue(king.in_check() and board.algebraic_history()[-1] == 'h8=R+'
                        and len(board.get_rooks(pychess.PieceColor.WHITE)) > 0)

    def test_rook_promotion_capture_check(self):
        board = pychess.board.SetupBoard('4k1b1/7P/8/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'hxg8=R')
    ...
    def test_queen_promotion_check(self):
        ...
        board.algebraic_move(pychess.PieceColor.WHITE, 'h8=Q')

        king = board.get_king(pychess.PieceColor.BLACK)

        self.assertTrue(king.in_check() and board.algebraic_history()[-1] == 'h8=Q+'
                        and len(board.get_queens(pychess.PieceColor.WHITE)) > 0)

    def test_queen_promotion_capture_check(self):
        board = pychess.board.SetupBoard('4k1b1/7P/8/8/8/8/8/4K3 w - -')

        board.algebraic_move(pychess.PieceColor.WHITE, 'hxg8=Q')
    ...
    def test_block_falling_diagonal_bishop_check(self):
        board = pychess.board.SetupBoard('rnbqk1nr/ppp2ppp/4p3/3p4/1b1P4/1P3N2/P1P1PPPP/RNBQKB1R w KQkq - 1 4')

        pieces = board.get_all_pieces(pychess.PieceColor.WHITE)
    ...
    def test_block_rising_diagonal_queen_check(self):
        board = pychess.board.SetupBoard('2kr1bnr/pbpp1ppp/1pn5/8/7q/2N1B3/PPPQP1PP/3RKBNR w KQkq -')
    ...
    def test_block_file_rook_check(self):
        board = pychess.board.SetupBoard('2k1rbnr/pbpp1ppp/1pn5/8/7q/1N6/PPPQ1BPP/3RKBNR w KQkq -')
    ...
    def test_block_file_queen_check(self):
        board = pychess.board.SetupBoard('2k1q1nr/pbpp1ppp/1pn5/8/7b/1N6/PPPQ1BPP/3RKBNR w KQkq -')
    ...
    def test_block_rank_queen_check(self):
        board = pychess.board.SetupBoard('4k3/7Q/B7/8/8/5N2/5PPP/q5K1 w - -')
    ...
    def test_block_rank_rook_check(self):
        board = pychess.board.SetupBoard('4k3/8/8/8/2nR4/1P2NQ2/P1P5/2K3r1 w - -')
    ...
    def test_force_capture_protected_queen(self):
        board = pychess.board.SetupBoard('3rk3/8/8/7B/2n5/1P6/P1P5/2Kq3R w - -')
    ...
    def test_force_capture_queen(self):
        board = pychess.board.SetupBoard('4k3/8/8/7B/2n5/1P6/P1P5/2Kq3R w - -')
